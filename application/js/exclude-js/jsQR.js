        ...
        /******/ [
                ...
                var GenericGF = /** @class */ (function () {
                    ...
                    GenericGF.prototype.multiply = function (a, b) {
                        ...
                        return this.expTable[
                            (this.logTable[a] + this.logTable[b]) %
                                (this.size - 1)
                        ];
                    };
                    ...
                    GenericGF.prototype.buildMonomial = function (
                        degree,
                        coefficient
                    ) {
                        if (degree < 0) {
                            throw new Error(
                                "Invalid monomial degree less than 0"
                            );
                        }
                        if (coefficient === 0) {
                            return this.zero;
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var GenericGFPoly = /** @class */ (function () {
                    ...
                    GenericGFPoly.prototype.multiplyPoly = function (other) {
                        ...
                        var product = new Uint8ClampedArray(
                            aLength + bLength - 1
                        );
                        ...
                        if (decoded) {
                            return {
                                ...
                                location: {
                                    ...
                                    topLeftCorner: extracted.mappingFunction(
                                        0,
                                        0
                                    ),
                                    ...
                                    bottomLeftFinderPattern:
                                        location_1.bottomLeft,
                                    bottomRightAlignmentPattern:
                                        location_1.alignmentPattern,
                                },
                            };
                        }
                    }
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                function binarize(data, width, height, returnInverted) {
                    ...
                    var binarized = BitMatrix_1.BitMatrix.createEmpty(
                        width,
                        height
                    );
                    var inverted = null;
                    if (returnInverted) {
                        inverted = BitMatrix_1.BitMatrix.createEmpty(
                            width,
                            height
                        );
                    }
                        ...
                        for (
                            ...
                            for (
                                ...
                                for (
                                    ...
                                    var x =
                                        hortizontalRegion * REGION_SIZE +
                                        xRegion;
                                    var y =
                                        verticalRegion * REGION_SIZE + yRegion;
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var DATA_MASKS = [
                    ...
                    function (p) {
                        return (
                            (Math.floor(p.y / 2) + Math.floor(p.x / 3)) % 2 ===
                            0
                        );
                    },
                    function (p) {
                ...
                function getDataBlocks(codewords, version, ecLevel) {
                    ...
                    var shortBlockSize =
                        ecInfo.ecBlocks[0].dataCodewordsPerBlock;
                ...
                function decodeMatrix(matrix) {
                    ...
                    for (
                        ...
                        var correctedBytes = reedsolomon_1.decode(
                            dataBlock.codewords,
                            dataBlock.codewords.length -
                                dataBlock.numDataCodewords
                        );
                        if (!correctedBytes) {
                            return null;
                        }
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                function decodeAlphanumeric(stream, size) {
                    ...
                    while (length >= 2) {
                        ...
                        text +=
                            AlphanumericCharacterCodes[a] +
                            AlphanumericCharacterCodes[b];
                        length -= 2;
                    }
                    if (length === 1) {
                ...
                function decodeKanji(stream, size) {
                    ...
                    for (var i = 0; i < length; i++) {
                        ...
                        text += String.fromCharCode(
                            shiftJISTable_1.shiftJISTable[c]
                        );
                    }
                    return { bytes: bytes, text: text };
                }
                function decode(data, version) {
                    ...
                    while (stream.available() >= 4) {
                        ...
                        if (mode === ModeByte.Terminator) {
                            ...
                            var alphanumericResult = decodeAlphanumeric(
                                stream,
                                size
                            );
                            result.text += alphanumericResult.text;
                            (_b = result.bytes).push.apply(
                                _b,
                                alphanumericResult.bytes
                            );
                            result.chunks.push({
                ...
                var BitStream = /** @class */ (function () {
                    ...
                    BitStream.prototype.readBits = function (numBits) {
                        ...
                        if (this.bitOffset > 0) {
                            ...
                            var toRead =
                                numBits < bitsLeft ? numBits : bitsLeft;
                        ...
                        if (numBits > 0) {
                            while (numBits >= 8) {
                                result =
                                    (result << 8) |
                                    (this.bytes[this.byteOffset] & 0xff);
                                this.byteOffset++;
                                numBits -= 8;
                            }
                            ...
                            if (numBits > 0) {
                                ...
                                var mask =
                                    (0xff >> bitsToNotRead) << bitsToNotRead;
                                result =
                                    (result << numBits) |
                                    ((this.bytes[this.byteOffset] & mask) >>
                                        bitsToNotRead);
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                function runEuclideanAlgorithm(field, a, b, R) {
                    ...
                    while (r.degree() >= R / 2) {
                        ...
                        while (r.degree() >= rLast.degree() && !r.isZero()) {
                            ...
                            q = q.addOrSubtract(
                                field.buildMonomial(degreeDiff, scale)
                            );
                            r = r.addOrSubtract(
                ...
                function findErrorLocations(field, errorLocator) {
                    ...
                    for (
                        var i = 1;
                        i < field.size && errorCount < numErrors;
                        i++
                    ) {
                ...
                function decode(bytes, twoS) {
                    ...
                    var errorLocations = findErrorLocations(
                        field,
                        sigmaOmega[0]
                    );
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                function computeDimension(
                    ...
                    var moduleSize =
                        (sum(
                            countBlackWhiteRun(topLeft, bottomLeft, matrix, 5)
                        ) /
                            7 + // Divide by 7 since the ratio is 1:1:3:1:1
                            sum(
                                countBlackWhiteRun(topLeft, topRight, matrix, 5)
                            ) /
                                7 +
                            sum(
                                countBlackWhiteRun(
                                ...
                                7 +
                            sum(
                                countBlackWhiteRun(topRight, topLeft, matrix, 5)
                            ) /
                                7) /
                        4;
                    if (moduleSize < 1) {
                ...
                function countBlackWhiteRun(origin, end, matrix, length) {
                    ...
                    var middleValue =
                        towardsEnd.shift() + awayFromEnd.shift() - 1; // Substract one so we don't double count a pixel
                ...
                function scorePattern(point, ratios, matrix) {
                    try {
                        ...
                        var horzError = scoreBlackWhiteRun(
                            horizontalRun,
                            ratios
                        );
                        ...
                        var sizeError =
                            (Math.pow(horzError.averageSize - avgSize, 2) +
                                ...
                                Math.pow(
                                    diagDownError.averageSize - avgSize,
                                    2
                                ) +
                                Math.pow(
                                    diagUpError.averageSize - avgSize,
                                    2
                                )) /
                            avgSize;
                    ...
                    var _loop_1 = function (y) {
                        ...
                        var _loop_2 = function (x) {
                            ...
                            if (v === lastBit) {
                                ...
                                var averageFinderPatternBlocksize =
                                    sum(scans) / 7;
                                var validFinderPattern =
                                    Math.abs(
                                        scans[0] - averageFinderPatternBlocksize
                                    ) < averageFinderPatternBlocksize &&
                                    Math.abs(
                                        scans[1] - averageFinderPatternBlocksize
                                    ) < averageFinderPatternBlocksize &&
                                    Math.abs(
                                        scans[2] -
                                        ...
                                        3 * averageFinderPatternBlocksize &&
                                    Math.abs(
                                        scans[3] - averageFinderPatternBlocksize
                                    ) < averageFinderPatternBlocksize &&
                                    Math.abs(
                                        scans[4] - averageFinderPatternBlocksize
                                    ) < averageFinderPatternBlocksize &&
                ...
                function findAlignmentPattern(
                    ...
                    var modulesBetweenFinderPatterns =
                        ...
                        2 /
                        moduleSize;
                    var correctionToTopLeft =
                        1 - 3 / modulesBetweenFinderPatterns;
                    ...
                    var alignmentPattern =
                        modulesBetweenFinderPatterns >= 15 &&
                        alignmentPatterns.length
                            ? alignmentPatterns[0]
                            : expectedAlignmentPattern;
                    return {
