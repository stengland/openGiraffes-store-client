var __extends =
  ...
  (function () {
    ...
    return function (z, v) {
      ...
      D(z, v);
      z.prototype =
        null === v ? Object.create(v) : ((A.prototype = v.prototype), new A());
    };
  })();
  ...
  var D = (function (r) {
    function l() {
          ...
          -1 !== a._KEYS.KEY_ENTER.indexOf(c)
            ...
            ((I = 1),
              (H = setTimeout(function () {
                G++;
                h.dispatchEvent(
                  new CustomEvent("longPress", { detail: { el: h } })
                );
                clearTimeout(H);
              }, a._longPressTime)))
      ...
      a.init = function (b) {
        ...
        a._findFocusType =
          void 0 === b.findFocusType ? a._findFocusType : b.findFocusType;
        ...
        a._offsetDistance =
          void 0 === b.offsetDistance ? a._offsetDistance : b.offsetDistance;
        a._longPressTime =
          void 0 === b.longPressTime ? a._longPressTime : b.longPressTime;
        a._distanceToCenter =
      ...
      a.requestFocus = function (b, c) {
        ...
        for (
          var d = document.getElementsByClassName(a._focusClassName), f = 0;
          f < d.length;
          f++
        )
        ...
        a.getNextFocusElement = function (b) {
          ...
          for (p = 0; p < c.length; p++) {
            ...
            if (document.querySelector("." + a._focusClassName) !== m) {
              if ("up" === b) {
                q = e.top + e.height;
                if ((e.right < t[3] || e.left > t[1]) && e.bottom > t[0])
                  continue;
                ...
                C = e.left;
                if ((e.bottom < t[0] || e.top > t[2]) && e.left < t[1])
                  continue;
                ...
                C = e.left + e.width;
                if ((e.bottom < t[0] || e.top > t[2]) && e.right > t[3])
                  continue;
                if (Math.round(C) >= d) continue;
                q = e.top + e.height / 2;
                n = e.top;
